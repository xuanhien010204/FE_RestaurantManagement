...
import { SearchOutlined, PlusOutlined, EditOutlined, DeleteOutlined, TableOutlined, CheckOutlined, CloseOutlined } from '@ant-design/icons';
...
const TableManagementPage: React.FC = () => {
    ...
    return (
        <div className="p-6">
            <Card title="Quản lý bàn ăn" className="mb-6">
